...
sealed class CollectionEvents {
    ...
    object ConfirmDeleteSelected : CollectionEvents()
    object ShowDeleteSelectedConfirmDialog : CollectionEvents()
    object HideDeleteSelectedConfirmDialog : CollectionEvents()
    ...
    object ConfirmRemoveSelectedFromCollection : CollectionEvents()
    object ShowRemoveFromCollectionConfirmDialog : CollectionEvents()
    object HideRemoveFromCollectionConfirmDialog : CollectionEvents()
